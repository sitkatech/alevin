...
IF EXISTS(SELECT * FROM Reclamation.CostAuthority)
	 EXEC('INSERT INTO Reclamation.Tmp_CostAuthority (CostAuthorityID, CostAuthorityWorkBreakdownStructure, CostAuthorityNumber, AccountStructureDescription, CostCenter, AgencyProjectType, ProjectNumber, Job, Number, JobNumber, Authority, WBSStatus, HCategoryLU, WBSNoDot, HabitatCategoryID, BasinID, SubbasinID)
		SELECT CostAuthorityID, CostAuthorityWorkBreakdownStructure, CostAuthorityNumber, AccountStructureDescription, CostCenter, AgencyProjectType, ProjectNumber, Job, Number, JobNumber, Authority, WBSStatus, HCategoryLU, WBSNoDot, HabitatCategoryID, BasinID, SubbasinID FROM Reclamation.CostAuthority WITH (HOLDLOCK TABLOCKX)')
GO
