...
alter table dbo.ActionItem add constraint FK_ActionItem_Person_AssignedToPersonID_TenantID foreign key (AssignedToPersonID, TenantID) references dbo.Person(PersonID, TenantID)
go
