...
ALTER TABLE ImportFinancial.WbsElementPnBudget
	DROP CONSTRAINT FK_WbsElementPnBudget_BudgetObjectCode_BudgetObjectCodeID
GO
ALTER TABLE Reclamation.BudgetObjectCode SET (LOCK_ESCALATION = TABLE)
GO
...
ALTER TABLE ImportFinancial.WbsElementPnBudget
	DROP CONSTRAINT FK_WbsElementPnBudget_CostAuthority_CostAuthorityID
GO
...
IF EXISTS(SELECT * FROM ImportFinancial.WbsElementPnBudget)
	 EXEC('INSERT INTO ImportFinancial.Tmp_WbsElementPnBudget (WbsElementPnBudgetID, WbsElementID, CostAuthorityID, PnBudgetFundTypeID, FundingSourceID, FundsCenter, FiscalQuarterID, FiscalYear, BudgetObjectCodeID, FIDocNumber, Recoveries, CommittedButNotObligated, TotalObligations, TotalExpenditures, UndeliveredOrders)
		SELECT WbsElementPnBudgetID, WbsElementID, CostAuthorityID, PnBudgetFundTypeID, FundingSourceID, FundsCenter, FiscalQuarterID, FiscalYear, BudgetObjectCodeID, FIDocNumber, Recoveries, CommittedButNotObligated, TotalObligations, TotalExpenditures, UndeliveredOrders FROM ImportFinancial.WbsElementPnBudget WITH (HOLDLOCK TABLOCKX)')
GO
...
GO
ALTER TABLE ImportFinancial.WbsElementPnBudget ADD CONSTRAINT
	FK_WbsElementPnBudget_CostAuthority_CostAuthorityID FOREIGN KEY
	(
	CostAuthorityID
...
GO
ALTER TABLE ImportFinancial.WbsElementPnBudget ADD CONSTRAINT
	FK_WbsElementPnBudget_BudgetObjectCode_BudgetObjectCodeID FOREIGN KEY
	(
	BudgetObjectCodeID
	) REFERENCES Reclamation.BudgetObjectCode
	(
	BudgetObjectCodeID
	) ON UPDATE  NO ACTION 
	 ON DELETE  NO ACTION 
