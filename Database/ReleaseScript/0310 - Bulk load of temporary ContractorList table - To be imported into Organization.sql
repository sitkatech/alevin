DROP TABLE IF EXISTS [dbo].[ContractorList]
...
ALTER TABLE [dbo].[ContractorList] ADD  CONSTRAINT [AK_ContractorList_ReclamationContractorID] UNIQUE NONCLUSTERED 
(
    [ReclamationContractorID] ASC
) ON [PRIMARY]
GO
