...
GO
ALTER TABLE Reclamation.CostAuthorityObligationRequestPotentialObligationNumberMatch
	DROP CONSTRAINT FK_CostAuthorityObligationRequestPotentialObligationNumberMatch_ObligationNumber_ObligationNumberID
GO
...
GO
ALTER TABLE Reclamation.CostAuthorityObligationRequestPotentialObligationNumberMatch
	DROP CONSTRAINT FK_CostAuthorityObligationRequestPotentialObligationNumberMatch_CostAuthorityObligationRequest_CostAuthorityObligationRequest
GO
