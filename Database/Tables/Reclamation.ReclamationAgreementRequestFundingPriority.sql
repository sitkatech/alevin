...
GO
CREATE TABLE [Reclamation].[ReclamationAgreementRequestFundingPriority](
	[ReclamationAgreementRequestFundingPriorityID] [int] IDENTITY(1,1) NOT NULL,
	[ReclamationAgreementRequestFundingPriorityName] [varchar](255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
