...
GO
CREATE TABLE [dbo].[ReclamationAgreement](
...
GO
ALTER TABLE [dbo].[ReclamationAgreement] CHECK CONSTRAINT [FK_ReclamationAgreement_ReclamationContractType_ContractTypeID_ReclamationContractTypeID]