...
GO
ALTER TABLE [Reclamation].[CostAuthorityProject]  WITH CHECK ADD  CONSTRAINT [FK_ReclamationCostAuthorityProject_Project_ProjectID] FOREIGN KEY([ProjectID])
REFERENCES [dbo].[Project] ([ProjectID])
GO
ALTER TABLE [Reclamation].[CostAuthorityProject] CHECK CONSTRAINT [FK_ReclamationCostAuthorityProject_Project_ProjectID]
GO
ALTER TABLE [Reclamation].[CostAuthorityProject]  WITH CHECK ADD  CONSTRAINT [FK_ReclamationCostAuthorityProject_ReclamationCostAuthority_ReclamationCostAuthorityID] FOREIGN KEY([ReclamationCostAuthorityID])
REFERENCES [Reclamation].[CostAuthority] ([ReclamationCostAuthorityID])
GO
ALTER TABLE [Reclamation].[CostAuthorityProject] CHECK CONSTRAINT [FK_ReclamationCostAuthorityProject_ReclamationCostAuthority_ReclamationCostAuthorityID]