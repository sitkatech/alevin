...
GO
CREATE TABLE [dbo].[ReclamationStagingCostAuthorityWorkBreakdownStructurePacificNorthActivityList](
...
GO
ALTER TABLE [dbo].[ReclamationStagingCostAuthorityWorkBreakdownStructurePacificNorthActivityList]  WITH CHECK ADD  CONSTRAINT [FK_ReclamationStagingCostAuthorityWorkBreakdownStructurePacificNorthActivityList_ReclamationPacificNorthActivityList_PacificNort] FOREIGN KEY([PacificNorthActivityListID])
REFERENCES [dbo].[ReclamationPacificNorthActivityList] ([ReclamationPacificNorthActivityListID])
GO
ALTER TABLE [dbo].[ReclamationStagingCostAuthorityWorkBreakdownStructurePacificNorthActivityList] CHECK CONSTRAINT [FK_ReclamationStagingCostAuthorityWorkBreakdownStructurePacificNorthActivityList_ReclamationPacificNorthActivityList_PacificNort]