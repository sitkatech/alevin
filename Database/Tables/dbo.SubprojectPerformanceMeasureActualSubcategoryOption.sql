...
GO
ALTER TABLE [dbo].[SubprojectPerformanceMeasureActualSubcategoryOption]  WITH CHECK ADD  CONSTRAINT [FK_SubprojectPerformanceMeasureActualSubcategoryOption_SubprojectPerformanceMeasureActual_SubprojectPerformanceMeasureActualID] FOREIGN KEY([SubprojectPerformanceMeasureActualID])
REFERENCES [dbo].[SubprojectPerformanceMeasureActual] ([SubprojectPerformanceMeasureActualID])
GO
ALTER TABLE [dbo].[SubprojectPerformanceMeasureActualSubcategoryOption] CHECK CONSTRAINT [FK_SubprojectPerformanceMeasureActualSubcategoryOption_SubprojectPerformanceMeasureActual_SubprojectPerformanceMeasureActualID]
GO
ALTER TABLE [dbo].[SubprojectPerformanceMeasureActualSubcategoryOption]  WITH CHECK ADD  CONSTRAINT [FK_SubprojectPerformanceMeasureActualSubcategoryOption_SubprojectPerformanceMeasureActual_SubprojectPerformanceMeasureActualID_P] FOREIGN KEY([SubprojectPerformanceMeasureActualID], [PerformanceMeasureID])
REFERENCES [dbo].[SubprojectPerformanceMeasureActual] ([SubprojectPerformanceMeasureActualID], [PerformanceMeasureID])
GO
ALTER TABLE [dbo].[SubprojectPerformanceMeasureActualSubcategoryOption] CHECK CONSTRAINT [FK_SubprojectPerformanceMeasureActualSubcategoryOption_SubprojectPerformanceMeasureActual_SubprojectPerformanceMeasureActualID_P]
GO
