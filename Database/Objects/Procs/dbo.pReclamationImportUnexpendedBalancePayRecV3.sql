...
begin
   raiserror('Expected no records with a null PostingDatePerSpl and a value greater than 0 in UexpendedBalance in ImportFinancial.ImportFinancialImpPayRecUnexpendedV3. But found some.', 16,1)
   return -1
end
