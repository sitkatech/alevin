...
(10016, N'ObligationRequestID', N'Obligation Request ID'),
...
(10032, N'CostAuthorityObligationRequestNote', N'Note on projected obligation from a CAWBS to an Agreement'),
(10033, N'ObligationRequestSubmissionNote', N'Submission Note'),
