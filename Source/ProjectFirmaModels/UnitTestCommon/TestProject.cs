    ...
    public static partial class TestFramework
    {
        public static class TestProject
        {
            public static Project Create()
            {
                ...
                // Project.
                var project = new Project(projectStage, testProjectName, testProjectDescription, isFeatured, ProjectLocationSimpleType.None, ProjectApprovalStatus.Approved, DateTime.Now, ProjectCategory.Normal);
