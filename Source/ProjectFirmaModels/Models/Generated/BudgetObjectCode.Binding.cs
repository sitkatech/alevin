...
namespace ProjectFirmaModels.Models
{
    ...
    public partial class BudgetObjectCode : IHavePrimaryKey, ICanDeleteFull
    {
        ...
        /// </summary>
        public static readonly List<string> DependentEntityTypeNames = new List<string> {typeof(BudgetObjectCode).Name, typeof(WbsElementObligationItemBudget).Name, typeof(WbsElementObligationItemInvoice).Name, typeof(WbsElementPnBudget).Name};
