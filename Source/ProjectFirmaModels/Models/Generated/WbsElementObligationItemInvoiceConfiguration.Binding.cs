...
namespace ProjectFirmaModels.Models
{
    public class WbsElementObligationItemInvoiceConfiguration : EntityTypeConfiguration<WbsElementObligationItemInvoice>
    {
        ...
        public WbsElementObligationItemInvoiceConfiguration(string schema)
        {
            ...
            HasRequired(a => a.FundingSource).WithMany(b => b.WbsElementObligationItemInvoices).HasForeignKey(c => c.FundingSourceID).WillCascadeOnDelete(false); // FK_WbsElementObligationItemInvoice_FundingSource_FundingSourceID
        }
    }
}