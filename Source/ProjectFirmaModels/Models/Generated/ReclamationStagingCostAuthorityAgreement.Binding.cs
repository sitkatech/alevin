...
{
    // Table [dbo].[ReclamationStagingCostAuthorityAgreement] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[dbo].[ReclamationStagingCostAuthorityAgreement]")]
