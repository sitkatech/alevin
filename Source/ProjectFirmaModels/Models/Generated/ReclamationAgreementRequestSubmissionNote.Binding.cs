...
{
    // Table [Reclamation].[ReclamationAgreementRequestSubmissionNote] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[Reclamation].[ReclamationAgreementRequestSubmissionNote]")]
