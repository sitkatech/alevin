...
{
    // Table [Reclamation].[ReclamationAgreementPacificNorthActivity] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[Reclamation].[ReclamationAgreementPacificNorthActivity]")]
