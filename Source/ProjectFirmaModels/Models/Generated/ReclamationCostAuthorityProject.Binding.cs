...
{
    // Table [Reclamation].[ReclamationCostAuthorityProject] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[Reclamation].[ReclamationCostAuthorityProject]")]
