...
namespace ProjectFirmaModels.Models
{
    public class ReclamationStagingCostAuthorityAgreementConfiguration : EntityTypeConfiguration<ReclamationStagingCostAuthorityAgreement>
    {
        ...
        public ReclamationStagingCostAuthorityAgreementConfiguration(string schema)
        {
            ...
            HasOptional(a => a.CostAuthority).WithMany(b => b.ReclamationStagingCostAuthorityAgreements).HasForeignKey(c => c.CostAuthorityID).WillCascadeOnDelete(false); // FK_ReclamationStagingCostAuthorityAgreement_CostAuthority_CostAuthorityID
        }
    }
}