...
namespace ProjectFirmaModels.Models
{
    public abstract partial class ProjectCreateSection : IHavePrimaryKey
    {
        ...
        {
            All = new List<ProjectCreateSection> { Basics, LocationSimple, Organizations, LocationDetailed, ExpectedAccomplishments, ReportedAccomplishments, Budget, Classifications, Assessment, Photos, Contacts, AttachmentsAndNotes, CustomAttributes, BulkSetSpatialInformation, PartnerFinder };
