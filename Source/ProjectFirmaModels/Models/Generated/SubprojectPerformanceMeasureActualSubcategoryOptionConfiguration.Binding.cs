...
namespace ProjectFirmaModels.Models
{
    public class SubprojectPerformanceMeasureActualSubcategoryOptionConfiguration : EntityTypeConfiguration<SubprojectPerformanceMeasureActualSubcategoryOption>
    {
        ...
        public SubprojectPerformanceMeasureActualSubcategoryOptionConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.SubprojectPerformanceMeasureActual).WithMany(b => b.SubprojectPerformanceMeasureActualSubcategoryOptions).HasForeignKey(c => c.SubprojectPerformanceMeasureActualID).WillCascadeOnDelete(false); // FK_SubprojectPerformanceMeasureActualSubcategoryOption_SubprojectPerformanceMeasureActual_SubprojectPerformanceMeasureActualID
