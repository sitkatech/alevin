...
namespace ProjectFirmaModels.Models
{
    public class WbsElementPnBudgetConfiguration : EntityTypeConfiguration<WbsElementPnBudget>
    {
        ...
        public WbsElementPnBudgetConfiguration(string schema)
        {
            ...
            Property(x => x.CommitmentItemID).HasColumnName(@"CommitmentItemID").HasColumnType("int").IsRequired();
            ...
            HasRequired(a => a.CommitmentItem).WithMany(b => b.WbsElementPnBudgets).HasForeignKey(c => c.CommitmentItemID).WillCascadeOnDelete(false); // FK_WbsElementPnBudget_CommitmentItem_CommitmentItemID
        }
    }
}