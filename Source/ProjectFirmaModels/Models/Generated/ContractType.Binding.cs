...
{
    // Table [dbo].[ContractType] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[dbo].[ContractType]")]
    public partial class ContractType : IHavePrimaryKey, ICanDeleteFull
    {
        ...
        /// </summary>
        public static readonly List<string> DependentEntityTypeNames = new List<string> {typeof(ContractType).Name, typeof(Agreement).Name};
