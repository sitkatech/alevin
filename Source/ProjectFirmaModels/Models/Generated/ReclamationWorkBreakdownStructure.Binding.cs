...
{
    // Table [Reclamation].[ReclamationWorkBreakdownStructure] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[Reclamation].[ReclamationWorkBreakdownStructure]")]
