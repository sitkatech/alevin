...
{
    // Table [Reclamation].[ReclamationPacificNorthActivityStatus] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[Reclamation].[ReclamationPacificNorthActivityStatus]")]
