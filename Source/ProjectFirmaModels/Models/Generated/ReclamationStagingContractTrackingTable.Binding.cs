...
{
    // Table [dbo].[ReclamationStagingContractTrackingTable] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[dbo].[ReclamationStagingContractTrackingTable]")]
