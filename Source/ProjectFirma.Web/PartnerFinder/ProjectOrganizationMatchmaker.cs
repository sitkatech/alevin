...
namespace ProjectFirma.Web.PartnerFinder
{
    ...
    public class ProjectOrganizationMatchmaker
    {
        ...
        private static double GetTaxonomySubScore(Project project, Organization organization)
        {
            ...
            var matchesLeaf = matchmakerLeaves.Any(x => x.TaxonomyLeafID == project.OverrideTaxonomyLeafID);
            var matchesLeafForBranch = matchmakerLeavesFromSelectedBranches.Any(x => x.TaxonomyLeafID == project.OverrideTaxonomyLeafID);
            var matchesLeafForTrunk = matchmakerLeavesFromSelectedTrunks.Any(x => x.TaxonomyLeafID == project.OverrideTaxonomyLeafID);
