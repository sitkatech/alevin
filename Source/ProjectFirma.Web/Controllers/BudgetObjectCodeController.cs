...
namespace ProjectFirma.Web.Controllers
{
    public class BudgetObjectCodeController : FirmaBaseController
    {
		...
		// Hard wired TEST
		[BudgetObjectCodeViewFeature]
        public ContentResult BocV2Test()
        {
            string rawHtmlHackedPageContent = System.IO.File.ReadAllText(@"C:\git\sitkatech\alevin\Source\ProjectFirma.Web\Views\BudgetObjectCode\BocV2.html");
            return Content(rawHtmlHackedPageContent, "text/html");
        }
        ...
        */
        ...
        public ActionResult BudgetObjectCodeGridJsonDataV2_JSON_SAMPLE()
        {
			...
			//var gridJsonNetJObjectResult = new GridJsonNetJObjectResult<BudgetObjectCode>(budgetObjectCodes, gridSpec);
			//return gridJsonNetJObjectResult;
			//return new JsonResult(SampleTreeGridJson());
			string jsonString = SampleTreeGridJson();
			return Content(jsonString, "application/json");
		}

		public string SampleTreeGridJson()
        {
            string sampleJson = @"
[
	{
