/*-----------------------------------------------------------------------
<copyright file="SubprojectNoteController.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
    ...
    public class SubprojectNoteController : FirmaBaseController
    {
        ...
        private PartialViewResult ViewDeleteProjectNote(SubprojectNote subprojectNote, ConfirmDialogFormViewModel viewModel)
        {
            ...
            var confirmMessage = canDelete
                ? $"Are you sure you want to delete this note for {FieldDefinitionEnum.Project.ToType().GetFieldDefinitionLabel()} '{subprojectNote.Subproject.GetDisplayName()}'?"
