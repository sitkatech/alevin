            ...
            , List<int> sitkaAdminPersonIDs)
        {
            ...
            switch (projectCustomGridConfiguration.ProjectCustomGridColumn.ToEnum)
            {
                ...
                case ProjectCustomGridColumnEnum.PrimaryTaxonomyLeaf:
                    ...
                    Add(gridHeaderString, x => new HtmlLinkObject(projectDetailsDictionary[x.ProjectID].TaxonomyLeafDisplayName,TaxonomyLeafModelExtensions.DetailUrlTemplate.ParameterReplace(projectDetailsDictionary[x.ProjectID].TaxonomyLeafID ?? -1)).ToJsonObjectForAgGrid(), 240, AgGridColumnFilterType.HtmlLinkJson);
                    break;
