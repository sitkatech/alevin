...
{
    public class BudgetObjectCodeTreeGridSpecV2 : GridSpec<ProjectFirmaModels.Models.BudgetObjectCode>
    {
        public BudgetObjectCodeTreeGridSpecV2(FirmaSession currentFirmaSession)
        {
