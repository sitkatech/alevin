...
namespace ProjectFirma.Web.Models
{
    public static class TaxonomyTrunkModelExtensions
    {
        ...
        {
            return taxonomyTrunk.TaxonomyBranches.SelectMany(x => x.TaxonomyLeafs.SelectMany(y => y.GetProjects())).ToList().GetActiveProjectsAndProposals(firmaSession.CanViewProposals(), firmaSession);
        }
