...
namespace ProjectFirma.Web.Models
{
    public static class ObligationModelExtensions
    {
        ...
        public static readonly UrlTemplate<int> ObligationDetailUrlTemplate = new UrlTemplate<int>(SitkaRoute<ObligationController>.BuildUrlFromExpression(t => t.ObligationDetail(UrlTemplate.Parameter1Int)));
